...
export const CHECK_BAL_INTERVAL = Number(process.env.CHECK_BAL_INTERVAL || '3000')
...
// Jito settings (optional - will use empty string if not provided)
...
export const JITO_FEE = Number(process.env.JITO_FEE || '120000')